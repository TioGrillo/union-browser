...
release_name = "UNION BROWSER V1.0.8"
tag_name = "v1.0.8"
...
r_rel = requests.post(f"{repo_url}/releases", headers=HEADERS, json={
    "tag_name": tag_name,
    "name": release_name,
    "body": "Nova compilação (Versão 1.0.8) - Corrigido parse de proxy (host:port:user:pass) e suporte a manter abas rodando em background ao trocar de workspace.",
    "draft": False,
    "prerelease": False
})
...
file_path = r"C:\Users\Damiao\Documents\IdleBrowser\release\UNION BROWSER 1.0.8.exe"
file_name = "UNION_BROWSER_1.0.8.exe"
