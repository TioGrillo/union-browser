...
release_name = "UNION BROWSER V1.0.5"
tag_name = "v1.0.5"
...
r_rel = requests.post(f"{repo_url}/releases", headers=HEADERS, json={
    "tag_name": tag_name,
    "name": release_name,
    "body": "Nova compilação (Versão 1.0.5) - Correção de erro EBUSY no download de atualização.",
    "draft": False,
    "prerelease": False
})
...
file_path = r"C:\Users\Damiao\Documents\IdleBrowser\release\UNION BROWSER 1.0.5.exe"
file_name = "UNION_BROWSER_1.0.5.exe"
